  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8" dir="rtl">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white border border-slate-200 p-4 sm:p-6 rounded-2xl shadow-sm mb-8 space-y-4">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-white border border-slate-300 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-600 text-sm"
            />
          </div>
        ...
        {filteredArticles.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredArticles.map((article) => (
              <article
                key={article.id}
                className="bg-white rounded-2xl p-6 border border-slate-200 hover:border-blue-600 transition flex flex-col justify-between group"
              >
                <div>
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-[11px] text-slate-500">{article.publishDate}</span>
                  </div>

                  <h2 className="text-lg font-bold text-slate-900 mb-2 leading-snug group-hover:text-blue-700 transition">
                ...
                <div className="pt-4 border-t border-slate-200 flex justify-between items-center">
                  <span className="text-[11px] text-slate-500">إشراف: د. هيثم الخطيب</span>
                  <Link

...
export default function Home() {
  ...
  return (
    <div className="space-y-16 py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto" dir="rtl">
      ...
      {/* 2. البانر الطبي المستطيل مباشرة تحت الواجهة الترحيبية */}
      <section className="relative overflow-hidden rounded-3xl border-2 border-rose-300 shadow-2xl bg-gradient-to-r from-rose-950 via-rose-900 to-slate-950 text-white">
        <a
          href="https://wa.me/966599287172"
          target="_blank"
          rel="noopener noreferrer"
        ...
        >
          <div className="w-full relative overflow-hidden min-h-[260px] sm:min-h-[340px] flex items-center justify-between p-6 sm:p-10">
            
            {/* الصورة مع محاولات متعددة لروابط GitHub و Local */}
            {!imgError && (
              <img
                src="https://raw.githubusercontent.com/femseha/femseha/main/public/banner.jpg.png"
                alt="د. هيثم الخطيب"
                onError={(e) => {
            ...
            {/* طبقة التظليل والنصوص التوضيحية العريضة */}
            <div className="relative z-10 max-w-2xl space-y-3 bg-slate-950/80 p-6 sm:p-8 rounded-2xl backdrop-blur-md border border-white/20">
              <span className="bg-emerald-500 text-white text-sm sm:text-base font-black px-4 py-1.5 rounded-full inline-block">
                ● الاستشارات الطبية والعيادة متاحة الآن
              </span>
              ...
              <p className="text-slate-200 text-base sm:text-lg leading-relaxed font-medium">
                استشارات حالات الحمل الحرج، بروتوكولات ميزوبروستول (سايتوتك) بالمستشفيات، وعلاج العقم في السعودية والخليج.
              </p>
            </div>

            <div className="relative z-10 hidden md:block">
              <span className="bg-emerald-600 hover:bg-emerald-500 text-white font-black px-8 py-4 rounded-2xl shadow-2xl text-lg flex items-center gap-3 transition">
      ...
      <section className="bg-white rounded-3xl p-8 sm:p-14 border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="bg-gradient-to-br from-rose-50 to-slate-100 p-8 sm:p-10 rounded-3xl border border-rose-100 text-center w-full md:w-84 space-y-4 shadow-inner">
          <img
            src="https://raw.githubusercontent.com/femseha/femseha/main/public/logo.png.png"
            alt="شعار Femseha"
            onError={(e) => {
              const target = e.target as HTMLImageElement;
              if (target.src.includes('raw.githubusercontent.com')) {
                target.src = '/logo.png.png';
              } else if (target.src.endsWith('/logo.png.png')) {
                target.src = '/logo.png';
              } else {

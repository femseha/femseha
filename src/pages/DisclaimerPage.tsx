    ...
    <div className="bg-slate-50 py-12 px-4 sm:px-6 lg:px-8" dir="rtl">
      <div className="max-w-3xl mx-auto">
        <nav aria-label="مسار التنقل" className="text-xs text-slate-500 mb-6">
          ...
          <span className="text-slate-700 font-semibold">إخلاء المسؤولية الطبية</span>
        </nav>

        <div className="bg-white border border-slate-200 rounded-3xl shadow-lg p-8 sm:p-10">
